...
elseif (CMAKE_SYSTEM_NAME STREQUAL "AmigaOS4")
  if (CMAKE_AMIGAOS4_GL_IMPL STREQUAL "mgl")
    find_library(OPENGL_gl_LIBRARY NAMES GL PATHS ${SDK}local/${C_LIB}/lib)
    find_path(OPENGL_INCLUDE_DIR GL/gl.h ${SDK}local/common/include)
    find_path(OPENGL_GLU_INCLUDE_DIR GL/glu.h ${SDK}local/common/include)
  else()
    find_library(OPENGL_gl_LIBRARY NAMES gl4es PATHS ${SDK}local/${C_LIB}/lib)
    find_path(OPENGL_INCLUDE_DIR GL4ES/gl.h ${SDK}local/common/include)
    find_path(OPENGL_GLU_INCLUDE_DIR GL4ES/glu.h ${SDK}local/common/include)
  endif()
  find_library(OPENGL_glu_LIBRARY NAMES GLU PATHS ${SDK}local/${C_LIB}/lib)
  list(APPEND _OpenGL_REQUIRED_VARS OPENGL_INCLUDE_DIR)

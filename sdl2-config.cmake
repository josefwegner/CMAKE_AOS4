...
set(prefix "/opt/ppc-amigaos/ppc-amigaos/SDK/local/newlib")
...
set(_sdl2_static_private_libs_in " -lm -athred=pthread -lpthread")
...
if (CMAKE_SYSTEM_NAME STREQUAL "AmigaOS4" AND NOT CMAKE_AMIGAOS4_GL_IMPL STREQUAL "mgl")
  set(_sdl2_static "${SDL2_LIBDIR}/libSDL2_gl4es.a")
else()
